...
?>
    <h2>
        ...
        <p>
            <?php if ( ($row['filename']) && (file_exists ($_SERVER['DOCUMENT_ROOT'] . '/php/blog/images/thumbs/' . $row['filename'])) ) { 
                echo "<img src=\"/php/blog/images/thumbs/{$row['filename']}\" alt=\"{$c_caption}\">";
            }
            ?>
