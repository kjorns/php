...
if (isset($_POST['delete'])) {
  $sql = 'DELETE FROM php_fp_blog WHERE article_id = ?';
  if ($stmt->prepare($sql)) {
...
<?php } else { ?>
        <h2 class="error">Please Confirm That You Want To Delete The Following item.<br>Note: This Action Cannot Be Un-Done.</h2>
            <ul>
