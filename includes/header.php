...
<div class="wrapper">
    ...
    <nav>
        ...
        <ul class="menu">
            ...
            <li><a <?php if($nav == 'blog') echo 'class="current"'; ?> href="/php/blog/index.php">Blog</a></li>
            <li><a <?php if($nav == 'final-project') echo 'class="current"'; ?> href="/php/final-project">Final Project</a></li>
            <li>
